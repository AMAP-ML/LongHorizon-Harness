...
def _real_time_worker(env_idx, task_queue, args, shared, progress):
    ...
    if _harness == "codex":
    ...
    elif _harness in {"cua_harness", "cua_harness_claudecode"}:
        from weavebench.agents.cua_harness_claudecode_agent import CuaHarnessClaudeCodeAgent as _AgentClass
        ...
        raise ValueError(
            ...
            "valid values: openclaw (default), codex, claudecode, cua_harness, "
            "cua_harness_claudecode, hermes"
        )

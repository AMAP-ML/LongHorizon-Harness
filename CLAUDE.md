...
**818 tests, all passing.** *(2026-08-13: 855 after the claude/codex backend port — `test_agent_worker.py`, `test_backends_claude_codex.py`; 905 after the backend-override work — `test_backend_toggle.py`.)*
